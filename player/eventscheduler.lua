...
local events =
{
    ...
    {schedule = random():getInt(80, 120) * 60, script = "alienattack", arguments = {3}, minimum = 80 * 60, to = 300},
    {schedule = random():getInt(90, 180) * 60, script = "alienattack", arguments = {4}, minimum = 120 * 60, to = 150},
    {schedule = random():getInt(90, 180) * 60, script = "alienattack", arguments = {5}, minimum = 120 * 60, to = 150},
